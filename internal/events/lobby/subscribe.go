...
// It wraps events.OnEvent[E] with a context assertion layer: the bus dispatches
...
func OnLobbyEvent[E LobbyEvent](bus events.Bus, handler func(ctx.LobbyContext, E)) {
