...
import (
	...
	mockservice "github.com/go-risk-it/go-risk-it/mocks/internal_/logic/game/move/service"
...
func testMetrics(t *testing.T) *metrics.Metrics {
	...
	meter := noop.Meter{}
	metricsResult, err := metrics.NewMetrics(meter)
