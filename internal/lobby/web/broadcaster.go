...
func (p *LobbyStateBroadcaster) fetchAndPublish(
	...
	safego.TypedSafeOp(lCtx, "fetchLobbyState", func(lCtx lobbyctx.LobbyContext) error {
	...
	safego.TypedSafeOp(lCtx, "dispatchLobbyState", func(lCtx lobbyctx.LobbyContext) error {
		dispatch(lCtx, msg)
