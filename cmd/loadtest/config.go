...
import (
	...
	"github.com/go-risk-it/go-risk-it/internal/loadtest/scenario"
)
...
func registerFlags(fs *flag.FlagSet) *Config {
	...
	fs.StringVar(&cfg.Server.MapFile, "map", "cmd/loadtest/map.json", "Path to map.json")
...
func (c *Config) Validate() error {
	if c.Server.AnonKey == "" {
		return errors.New("--anon-key flag or ANON_KEY env var is required")
	}
