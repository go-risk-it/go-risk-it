...
func (_m *PlayerStateChangedSignal) AddListener(handler signals.SignalListener[logicsignals.PlayerStateChangedData], key ...string) int {
	...
	var r0 int
	if rf, ok := ret.Get(0).(func(signals.SignalListener[logicsignals.PlayerStateChangedData], ...string) int); ok {
		r0 = rf(handler, key...)
	} else {
		r0 = ret.Get(0).(int)
	}
...
//   - handler signals.SignalListener[logicsignals.PlayerStateChangedData]
//   - key ...string
...
func (_c *PlayerStateChangedSignal_AddListener_Call) Run(run func(handler signals.SignalListener[logicsignals.PlayerStateChangedData], key ...string)) *PlayerStateChangedSignal_AddListener_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(signals.SignalListener[logicsignals.PlayerStateChangedData]), variadicArgs...)
	})
	return _c
}
...
func (_c *PlayerStateChangedSignal_AddListener_Call) RunAndReturn(run func(signals.SignalListener[logicsignals.PlayerStateChangedData], ...string) int) *PlayerStateChangedSignal_AddListener_Call {
	_c.Call.Return(run)
	return _c
}

// Emit provides a mock function with given fields: ctx, payload
func (_m *PlayerStateChangedSignal) Emit(ctx context.Context, payload logicsignals.PlayerStateChangedData) {
...
//   - ctx context.Context
//   - payload logicsignals.PlayerStateChangedData
...
func (_c *PlayerStateChangedSignal_Emit_Call) Run(run func(ctx context.Context, payload logicsignals.PlayerStateChangedData)) *PlayerStateChangedSignal_Emit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(logicsignals.PlayerStateChangedData))
	})
	return _c
}
...
func (_c *PlayerStateChangedSignal_Emit_Call) RunAndReturn(run func(context.Context, logicsignals.PlayerStateChangedData)) *PlayerStateChangedSignal_Emit_Call {
	_c.Call.Return(run)
	return _c
}
