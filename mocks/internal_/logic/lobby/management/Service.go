...
func (_e *Service_Expecter) GetUserLobbies(ctx1 any) *Service_GetUserLobbies_Call {
...
//   - ctx1 ctx.UserContext
//   - querier db.Querier
func (_e *Service_Expecter) GetUserLobbiesWithQuerier(ctx1 any, querier any) *Service_GetUserLobbiesWithQuerier_Call {
...
//   - name string
func (_e *Service_Expecter) JoinLobby(ctx1 any, name any) *Service_JoinLobby_Call {
...
//   - querier db.Querier
//   - name string
func (_e *Service_Expecter) JoinLobbyWithQuerier(ctx1 any, querier any, name any) *Service_JoinLobbyWithQuerier_Call {
