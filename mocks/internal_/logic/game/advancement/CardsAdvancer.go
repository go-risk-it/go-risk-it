...
func (_m *CardsAdvancer) AdvanceQ(_a0 ctx.GameContext, querier db.Querier) (sqlc.GamePhaseType, error) {
...
func (_c *CardsAdvancer_AdvanceQ_Call) Return(_a0 sqlc.GamePhaseType, _a1 error) *CardsAdvancer_AdvanceQ_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CardsAdvancer_AdvanceQ_Call) RunAndReturn(run func(ctx.GameContext, db.Querier) (sqlc.GamePhaseType, error)) *CardsAdvancer_AdvanceQ_Call {
	_c.Call.Return(run)
	return _c
}
