...
func (_m *Service[T, R]) AdvanceQ(_a0 ctx.GameContext, querier db.Querier) (sqlc.GamePhaseType, error) {
...
func (_c *Service_AdvanceQ_Call[T, R]) Return(_a0 sqlc.GamePhaseType, _a1 error) *Service_AdvanceQ_Call[T, R] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_AdvanceQ_Call[T, R]) RunAndReturn(run func(ctx.GameContext, db.Querier) (sqlc.GamePhaseType, error)) *Service_AdvanceQ_Call[T, R] {
	_c.Call.Return(run)
	return _c
}
