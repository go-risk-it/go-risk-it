...
//   - source string
//   - target string
func (_e *Graph_Expecter) AreNeighbours(source any, target any) *Graph_AreNeighbours_Call {
...
func (_e *Graph_Expecter) CanReach(ctx any, source any, target any, usableRegions any) *Graph_CanReach_Call {
