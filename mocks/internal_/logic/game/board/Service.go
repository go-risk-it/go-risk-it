...
//   - source string
//   - target string
func (_e *Service_Expecter) AreNeighbours(ctx any, source any, target any) *Service_AreNeighbours_Call {
...
//   - source string
//   - target string
func (_e *Service_Expecter) CanPlayerReach(ctx1 any, querier any, source any, target any) *Service_CanPlayerReach_Call {
...
func (_e *Service_Expecter) GetBoardRegions(ctx1 any) *Service_GetBoardRegions_Call {
...
//   - ctx1 ctx.GameContext
func (_e *Service_Expecter) GetContinents(ctx1 any) *Service_GetContinents_Call {
...
//   - querier db.Querier
//   - playerID int64
func (_e *Service_Expecter) GetContinentsControlledByPlayer(ctx1 any, querier any, playerID any) *Service_GetContinentsControlledByPlayer_Call {
