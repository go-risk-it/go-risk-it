...
type Advancer[R interface{}] struct {
	mock.Mock
}

type Advancer_Expecter[R interface{}] struct {
	mock *mock.Mock
}
...
func (_m *Advancer[R]) AdvanceQ(_a0 ctx.MoveContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult R) error {
...
type Advancer_AdvanceQ_Call[R interface{}] struct {
	*mock.Call
}
...
func (_c *Advancer_AdvanceQ_Call[R]) Run(run func(_a0 ctx.MoveContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult R)) *Advancer_AdvanceQ_Call[R] {
...
func (_c *Advancer_AdvanceQ_Call[R]) RunAndReturn(run func(ctx.MoveContext, db.Querier, sqlc.PhaseType, R) error) *Advancer_AdvanceQ_Call[R] {
	_c.Call.Return(run)
	return _c
}
...
func NewAdvancer[R interface{}](t interface {
	mock.TestingT
	Cleanup(func())
}) *Advancer[R] {
	mock := &Advancer[R]{}
