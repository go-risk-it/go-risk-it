...
func (_m *Service) Perform(_a0 ctx.GameContext, querier db.Querier, move reinforce.Move) (any, error) {
	...
	var r0 any
	var r1 error
	if rf, ok := ret.Get(0).(func(ctx.GameContext, db.Querier, reinforce.Move) (any, error)); ok {
		return rf(_a0, querier, move)
	}
	if rf, ok := ret.Get(0).(func(ctx.GameContext, db.Querier, reinforce.Move) any); ok {
	...
	if rf, ok := ret.Get(1).(func(ctx.GameContext, db.Querier, reinforce.Move) error); ok {
...
func (_c *Service_Perform_Call) Run(run func(_a0 ctx.GameContext, querier db.Querier, move reinforce.Move)) *Service_Perform_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.GameContext), args[1].(db.Querier), args[2].(reinforce.Move))
	})
	return _c
}
...
func (_c *Service_Perform_Call) RunAndReturn(run func(ctx.GameContext, db.Querier, reinforce.Move) (any, error)) *Service_Perform_Call {
	_c.Call.Return(run)
	return _c
}
