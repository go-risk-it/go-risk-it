...
func (_m *Service) AdvanceQ(_a0 ctx.GameContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult *reinforce.MoveResult) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ctx.GameContext, db.Querier, sqlc.PhaseType, *reinforce.MoveResult) error); ok {
...
//   - performResult *reinforce.MoveResult
...
func (_c *Service_AdvanceQ_Call) Run(run func(_a0 ctx.GameContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult *reinforce.MoveResult)) *Service_AdvanceQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.GameContext), args[1].(db.Querier), args[2].(sqlc.PhaseType), args[3].(*reinforce.MoveResult))
	})
	return _c
}
...
func (_c *Service_AdvanceQ_Call) RunAndReturn(run func(ctx.GameContext, db.Querier, sqlc.PhaseType, *reinforce.MoveResult) error) *Service_AdvanceQ_Call {
	_c.Call.Return(run)
	return _c
}

// PerformQ provides a mock function with given fields: _a0, querier, move
func (_m *Service) PerformQ(_a0 ctx.GameContext, querier db.Querier, move reinforce.Move) (*reinforce.MoveResult, error) {
	...
	var r0 *reinforce.MoveResult
	var r1 error
	if rf, ok := ret.Get(0).(func(ctx.GameContext, db.Querier, reinforce.Move) (*reinforce.MoveResult, error)); ok {
		return rf(_a0, querier, move)
	}
	if rf, ok := ret.Get(0).(func(ctx.GameContext, db.Querier, reinforce.Move) *reinforce.MoveResult); ok {
		r0 = rf(_a0, querier, move)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*reinforce.MoveResult)
		}
	}
...
func (_c *Service_PerformQ_Call) Run(run func(_a0 ctx.GameContext, querier db.Querier, move reinforce.Move)) *Service_PerformQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Service_PerformQ_Call) Return(_a0 *reinforce.MoveResult, _a1 error) *Service_PerformQ_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_PerformQ_Call) RunAndReturn(run func(ctx.GameContext, db.Querier, reinforce.Move) (*reinforce.MoveResult, error)) *Service_PerformQ_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Service) Walk(_a0 ctx.GameContext, querier db.Querier, voluntaryAdvancement bool) (sqlc.PhaseType, error) {
...
func (_c *Service_Walk_Call) RunAndReturn(run func(ctx.GameContext, db.Querier, bool) (sqlc.PhaseType, error)) *Service_Walk_Call {
	_c.Call.Return(run)
	return _c
}
