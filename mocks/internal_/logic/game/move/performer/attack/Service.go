...
func (_m *Service) PerformQ(_a0 ctx.MoveContext, querier db.Querier, game *state.Game, move attack.Move) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, db.Querier, *state.Game, attack.Move) error); ok {
...
func (_c *Service_PerformQ_Call) Run(run func(_a0 ctx.MoveContext, querier db.Querier, game *state.Game, move attack.Move)) *Service_PerformQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.MoveContext), args[1].(db.Querier), args[2].(*state.Game), args[3].(attack.Move))
	})
	return _c
}
...
func (_c *Service_PerformQ_Call) RunAndReturn(run func(ctx.MoveContext, db.Querier, *state.Game, attack.Move) error) *Service_PerformQ_Call {
	_c.Call.Return(run)
	return _c
}
