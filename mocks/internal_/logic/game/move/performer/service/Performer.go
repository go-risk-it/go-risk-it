...
func (_m *Performer[T]) PerformQ(_a0 ctx.MoveContext, querier db.Querier, game *sqlc.Game, move T) error {
...
func (_c *Performer_PerformQ_Call[T]) Run(run func(_a0 ctx.MoveContext, querier db.Querier, game *sqlc.Game, move T)) *Performer_PerformQ_Call[T] {
...
func (_c *Performer_PerformQ_Call[T]) RunAndReturn(run func(ctx.MoveContext, db.Querier, *sqlc.Game, T) error) *Performer_PerformQ_Call[T] {
	_c.Call.Return(run)
	return _c
}
