...
func (_m *ConquerOrchestrator) OrchestrateMove(_a0 ctx.MoveContext, phase sqlc.PhaseType, move conquer.Move) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, sqlc.PhaseType, conquer.Move) error); ok {
...
//   - move conquer.Move
func (_e *ConquerOrchestrator_Expecter) OrchestrateMove(_a0 interface{}, phase interface{}, move interface{}) *ConquerOrchestrator_OrchestrateMove_Call {
	return &ConquerOrchestrator_OrchestrateMove_Call{Call: _e.mock.On("OrchestrateMove", _a0, phase, move)}
}

func (_c *ConquerOrchestrator_OrchestrateMove_Call) Run(run func(_a0 ctx.MoveContext, phase sqlc.PhaseType, move conquer.Move)) *ConquerOrchestrator_OrchestrateMove_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.MoveContext), args[1].(sqlc.PhaseType), args[2].(conquer.Move))
	})
	return _c
}
...
func (_c *ConquerOrchestrator_OrchestrateMove_Call) RunAndReturn(run func(ctx.MoveContext, sqlc.PhaseType, conquer.Move) error) *ConquerOrchestrator_OrchestrateMove_Call {
	_c.Call.Return(run)
	return _c
}
