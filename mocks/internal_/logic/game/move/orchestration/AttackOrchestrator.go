...
func (_m *AttackOrchestrator) OrchestrateMove(_a0 ctx.MoveContext, phase sqlc.PhaseType, move attack.Move) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, sqlc.PhaseType, attack.Move) error); ok {
...
func (_c *AttackOrchestrator_OrchestrateMove_Call) Run(run func(_a0 ctx.MoveContext, phase sqlc.PhaseType, move attack.Move)) *AttackOrchestrator_OrchestrateMove_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.MoveContext), args[1].(sqlc.PhaseType), args[2].(attack.Move))
	})
	return _c
}
...
func (_c *AttackOrchestrator_OrchestrateMove_Call) RunAndReturn(run func(ctx.MoveContext, sqlc.PhaseType, attack.Move) error) *AttackOrchestrator_OrchestrateMove_Call {
	_c.Call.Return(run)
	return _c
}
