...
func (_m *Service) PerformQ(_a0 ctx.GameContext, querier db.Querier, move deploy.Move) (any, error) {
...
func (_c *Service_PerformQ_Call) RunAndReturn(run func(ctx.GameContext, db.Querier, deploy.Move) (any, error)) *Service_PerformQ_Call {
	_c.Call.Return(run)
	return _c
}
