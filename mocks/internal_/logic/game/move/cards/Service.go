...
func (_m *Service) AdvanceQ(_a0 ctx.MoveContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult *cards.MoveResult) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, db.Querier, sqlc.PhaseType, *cards.MoveResult) error); ok {
...
func (_c *Service_AdvanceQ_Call) Run(run func(_a0 ctx.MoveContext, querier db.Querier, targetPhase sqlc.PhaseType, performResult *cards.MoveResult)) *Service_AdvanceQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.MoveContext), args[1].(db.Querier), args[2].(sqlc.PhaseType), args[3].(*cards.MoveResult))
	})
	return _c
}
...
func (_c *Service_AdvanceQ_Call) RunAndReturn(run func(ctx.MoveContext, db.Querier, sqlc.PhaseType, *cards.MoveResult) error) *Service_AdvanceQ_Call {
	_c.Call.Return(run)
	return _c
}

// PerformQ provides a mock function with given fields: _a0, querier, move
func (_m *Service) PerformQ(_a0 ctx.MoveContext, querier db.Querier, move cards.Move) (*cards.MoveResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, db.Querier, cards.Move) (*cards.MoveResult, error)); ok {
		return rf(_a0, querier, move)
	}
	if rf, ok := ret.Get(0).(func(ctx.MoveContext, db.Querier, cards.Move) *cards.MoveResult); ok {
	...
	if rf, ok := ret.Get(1).(func(ctx.MoveContext, db.Querier, cards.Move) error); ok {
...
func (_c *Service_PerformQ_Call) Run(run func(_a0 ctx.MoveContext, querier db.Querier, move cards.Move)) *Service_PerformQ_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ctx.MoveContext), args[1].(db.Querier), args[2].(cards.Move))
	})
	return _c
}
...
func (_c *Service_PerformQ_Call) RunAndReturn(run func(ctx.MoveContext, db.Querier, cards.Move) (*cards.MoveResult, error)) *Service_PerformQ_Call {
	_c.Call.Return(run)
	return _c
}
