...
//   - n int
func (_e *Service_Expecter) RollAttackingDices(n any) *Service_RollAttackingDices_Call {
...
//   - n int
func (_e *Service_Expecter) RollDefendingDices(n any) *Service_RollDefendingDices_Call {
