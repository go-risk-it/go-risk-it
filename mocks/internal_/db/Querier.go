...
func (_c *Querier_GetPlayersByGameId_Call) Return(_a0 []db.Player, _a1 error) *Querier_GetPlayersByGameId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Querier_GetPlayersByGameId_Call) RunAndReturn(run func(context.Context, int64) ([]db.Player, error)) *Querier_GetPlayersByGameId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Querier) InsertPlayers(ctx context.Context, arg []db.InsertPlayersParams) (int64, error) {
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []db.InsertPlayersParams) (int64, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []db.InsertPlayersParams) int64); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, []db.InsertPlayersParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Querier_InsertPlayers_Call) Run(run func(ctx context.Context, arg []db.InsertPlayersParams)) *Querier_InsertPlayers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]db.InsertPlayersParams))
	})
	return _c
}
...
func (_c *Querier_InsertPlayers_Call) RunAndReturn(run func(context.Context, []db.InsertPlayersParams) (int64, error)) *Querier_InsertPlayers_Call {
	_c.Call.Return(run)
	return _c
}

// InsertRegions provides a mock function with given fields: ctx, arg
func (_m *Querier) InsertRegions(ctx context.Context, arg []db.InsertRegionsParams) (int64, error) {
	ret := _m.Called(ctx, arg)
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []db.InsertRegionsParams) (int64, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []db.InsertRegionsParams) int64); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, []db.InsertRegionsParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Querier_InsertRegions_Call) Run(run func(ctx context.Context, arg []db.InsertRegionsParams)) *Querier_InsertRegions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]db.InsertRegionsParams))
	})
	return _c
}
...
func (_c *Querier_InsertRegions_Call) RunAndReturn(run func(context.Context, []db.InsertRegionsParams) (int64, error)) *Querier_InsertRegions_Call {
	_c.Call.Return(run)
	return _c
}
