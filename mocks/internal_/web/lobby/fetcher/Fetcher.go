...
func (_m *Fetcher) FetchState(_a0 ctx.LobbyContext, stateChannel chan json.RawMessage) {
...
func (_c *Fetcher_FetchState_Call) Run(run func(_a0 ctx.LobbyContext, stateChannel chan json.RawMessage)) *Fetcher_FetchState_Call {
...
func (_c *Fetcher_FetchState_Call) RunAndReturn(run func(ctx.LobbyContext, chan json.RawMessage)) *Fetcher_FetchState_Call {
	_c.Run(run)
	return _c
}
