...
func (_m *Manager) ConnectPlayer(_a0 ctx.GameContext, connection *websocket.Conn) {
...
func (_c *Manager_ConnectPlayer_Call) Run(run func(_a0 ctx.GameContext, connection *websocket.Conn)) *Manager_ConnectPlayer_Call {
	_c.Call.Run(func(args mock.Arguments) {
