...
import (
	...
	response "github.com/go-risk-it/go-risk-it/internal/api/game/rest/response"
)
...
func (_m *GameController) GetUserGames(_a0 ctx.UserContext) (response.Games, error) {
	ret := _m.Called(_a0)
	...
	var r0 response.Games
	var r1 error
	if rf, ok := ret.Get(0).(func(ctx.UserContext) (response.Games, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(ctx.UserContext) response.Games); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(response.Games)
	}
...
// GameController_GetUserGames_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUserGames'
type GameController_GetUserGames_Call struct {
	*mock.Call
}

// GetUserGames is a helper method to define mock.On call
//   - _a0 ctx.UserContext
func (_e *GameController_Expecter) GetUserGames(_a0 interface{}) *GameController_GetUserGames_Call {
	return &GameController_GetUserGames_Call{Call: _e.mock.On("GetUserGames", _a0)}
}

func (_c *GameController_GetUserGames_Call) Run(run func(_a0 ctx.UserContext)) *GameController_GetUserGames_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GameController_GetUserGames_Call) Return(_a0 response.Games, _a1 error) *GameController_GetUserGames_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *GameController_GetUserGames_Call) RunAndReturn(run func(ctx.UserContext) (response.Games, error)) *GameController_GetUserGames_Call {
	_c.Call.Return(run)
	return _c
}
