...
func (_mock *Fetcher) FetchState(ctx1 ctx.GameContext, stateChannel chan json.RawMessage) {
...
func (_c *Fetcher_FetchState_Call) Run(run func(ctx1 ctx.GameContext, stateChannel chan json.RawMessage)) *Fetcher_FetchState_Call {
...
func (_c *Fetcher_FetchState_Call) RunAndReturn(run func(ctx1 ctx.GameContext, stateChannel chan json.RawMessage)) *Fetcher_FetchState_Call {
	_c.Run(run)
	return _c
}
