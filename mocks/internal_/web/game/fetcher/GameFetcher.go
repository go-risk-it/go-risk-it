...
// FetchState provides a mock function for the type GameFetcher
func (_mock *GameFetcher) FetchState(ctx1 ctx.GameContext, stateChannel chan json.RawMessage) {
...
func (_e *GameFetcher_Expecter) FetchState(ctx1 interface{}, stateChannel interface{}) *GameFetcher_FetchState_Call {
	return &GameFetcher_FetchState_Call{Call: _e.mock.On("FetchState", ctx1, stateChannel)}
}

func (_c *GameFetcher_FetchState_Call) Run(run func(ctx1 ctx.GameContext, stateChannel chan json.RawMessage)) *GameFetcher_FetchState_Call {
...
func (_c *GameFetcher_FetchState_Call) RunAndReturn(run func(ctx1 ctx.GameContext, stateChannel chan json.RawMessage)) *GameFetcher_FetchState_Call {
	_c.Run(run)
	return _c
}
