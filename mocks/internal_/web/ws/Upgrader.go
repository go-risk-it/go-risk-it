...
func (_m *Upgrader) Upgrade(w http.ResponseWriter, r *http.Request, responseHeader http.Header, args ...any) (*websocket.Conn, error) {
	var _ca []interface{}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(http.ResponseWriter, *http.Request, http.Header, ...any) (*websocket.Conn, error)); ok {
		return rf(w, r, responseHeader, args...)
	}
	if rf, ok := ret.Get(0).(func(http.ResponseWriter, *http.Request, http.Header, ...any) *websocket.Conn); ok {
	...
	if rf, ok := ret.Get(1).(func(http.ResponseWriter, *http.Request, http.Header, ...any) error); ok {
...
func (_c *Upgrader_Upgrade_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, http.Header, ...any) (*websocket.Conn, error)) *Upgrader_Upgrade_Call {
	_c.Call.Return(run)
	return _c
}
