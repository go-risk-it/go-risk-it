...
func (_m *Controller) GetBoardState(ctx context.Context, gameID int64) (message.BoardState, error) {
...
func (_c *Controller_GetBoardState_Call) Run(run func(ctx context.Context, gameID int64)) *Controller_GetBoardState_Call {
...
func (_c *Controller_GetBoardState_Call) RunAndReturn(run func(context.Context, int64) (message.BoardState, error)) *Controller_GetBoardState_Call {
	_c.Call.Return(run)
	return _c
}
