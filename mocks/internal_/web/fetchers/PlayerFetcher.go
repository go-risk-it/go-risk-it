...
func (_m *PlayerFetcher) FetchState(ctx context.Context, gameID int64, stateChannel chan json.RawMessage) {
...
func (_e *PlayerFetcher_Expecter) FetchState(ctx interface{}, gameID interface{}, stateChannel interface{}) *PlayerFetcher_FetchState_Call {
	return &PlayerFetcher_FetchState_Call{Call: _e.mock.On("FetchState", ctx, gameID, stateChannel)}
}

func (_c *PlayerFetcher_FetchState_Call) Run(run func(ctx context.Context, gameID int64, stateChannel chan json.RawMessage)) *PlayerFetcher_FetchState_Call {
...
func (_c *PlayerFetcher_FetchState_Call) RunAndReturn(run func(context.Context, int64, chan json.RawMessage)) *PlayerFetcher_FetchState_Call {
	_c.Call.Return(run)
	return _c
}
