...
func (_m *Fetcher) FetchState(_a0 ctx.GameContext, game *state.Game, stateChannel chan json.RawMessage) {
...
func (_e *Fetcher_Expecter) FetchState(_a0 interface{}, game interface{}, stateChannel interface{}) *Fetcher_FetchState_Call {
	return &Fetcher_FetchState_Call{Call: _e.mock.On("FetchState", _a0, game, stateChannel)}
}

func (_c *Fetcher_FetchState_Call) Run(run func(_a0 ctx.GameContext, game *state.Game, stateChannel chan json.RawMessage)) *Fetcher_FetchState_Call {
...
func (_c *Fetcher_FetchState_Call) RunAndReturn(run func(ctx.GameContext, *state.Game, chan json.RawMessage)) *Fetcher_FetchState_Call {
	_c.Call.Return(run)
	return _c
}
