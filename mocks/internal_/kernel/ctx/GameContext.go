...
func (_e *GameContext_Expecter) DetachOnto(base any) *GameContext_DetachOnto_Call {
...
//   - key any
func (_e *GameContext_Expecter) Value(key any) *GameContext_Value_Call {
...
//   - base context.Context
func (_e *GameContext_Expecter) WithBase(base any) *GameContext_WithBase_Call {
