...
// GameID provides a mock function with no fields
...
func (_m *GameContext) Span() trace.Span {
	ret := _m.Called()
...
func (_c *GameContext_Span_Call) Return(_a0 trace.Span) *GameContext_Span_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *GameContext) Value(key any) any {
	ret := _m.Called(key)
...
func (_c *GameContext_Value_Call) Return(_a0 any) *GameContext_Value_Call {
	_c.Call.Return(_a0)
	return _c
}
