...
// AssignGameWinner provides a mock function with given fields: _a0, arg
func (_m *Querier) AssignGameWinner(_a0 context.Context, arg sqlc.AssignGameWinnerParams) error {
...
func (_e *Querier_Expecter) AssignGameWinner(_a0 interface{}, arg interface{}) *Querier_AssignGameWinner_Call {
	return &Querier_AssignGameWinner_Call{Call: _e.mock.On("AssignGameWinner", _a0, arg)}
}

func (_c *Querier_AssignGameWinner_Call) Run(run func(_a0 context.Context, arg sqlc.AssignGameWinnerParams)) *Querier_AssignGameWinner_Call {
...
// DeleteSpuriousEliminatePlayerMissions provides a mock function with given fields: _a0, gameID
func (_m *Querier) DeleteSpuriousEliminatePlayerMissions(_a0 context.Context, gameID int64) error {
...
//   - _a0 context.Context
//   - gameID int64
func (_e *Querier_Expecter) DeleteSpuriousEliminatePlayerMissions(_a0 interface{}, gameID interface{}) *Querier_DeleteSpuriousEliminatePlayerMissions_Call {
	return &Querier_DeleteSpuriousEliminatePlayerMissions_Call{Call: _e.mock.On("DeleteSpuriousEliminatePlayerMissions", _a0, gameID)}
}

func (_c *Querier_DeleteSpuriousEliminatePlayerMissions_Call) Run(run func(_a0 context.Context, gameID int64)) *Querier_DeleteSpuriousEliminatePlayerMissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
//   - _a0 context.Context
//   - gameID int64
func (_e *Querier_Expecter) GetCurrentPlayer(_a0 interface{}, gameID interface{}) *Querier_GetCurrentPlayer_Call {
	return &Querier_GetCurrentPlayer_Call{Call: _e.mock.On("GetCurrentPlayer", _a0, gameID)}
}

func (_c *Querier_GetCurrentPlayer_Call) Run(run func(_a0 context.Context, gameID int64)) *Querier_GetCurrentPlayer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
//   - _a0 context.Context
//   - missionID int64
func (_e *Querier_Expecter) GetEliminatePlayerMission(_a0 interface{}, missionID interface{}) *Querier_GetEliminatePlayerMission_Call {
	return &Querier_GetEliminatePlayerMission_Call{Call: _e.mock.On("GetEliminatePlayerMission", _a0, missionID)}
}

func (_c *Querier_GetEliminatePlayerMission_Call) Run(run func(_a0 context.Context, missionID int64)) *Querier_GetEliminatePlayerMission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_e *Querier_Expecter) GetMission(_a0 interface{}, arg interface{}) *Querier_GetMission_Call {
	return &Querier_GetMission_Call{Call: _e.mock.On("GetMission", _a0, arg)}
}

func (_c *Querier_GetMission_Call) Run(run func(_a0 context.Context, arg sqlc.GetMissionParams)) *Querier_GetMission_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetPlayerToEliminate provides a mock function with given fields: _a0, missionID
func (_m *Querier) GetPlayerToEliminate(_a0 context.Context, missionID int64) (string, error) {
	ret := _m.Called(_a0, missionID)
...
//   - _a0 context.Context
//   - missionID int64
func (_e *Querier_Expecter) GetPlayerToEliminate(_a0 interface{}, missionID interface{}) *Querier_GetPlayerToEliminate_Call {
	return &Querier_GetPlayerToEliminate_Call{Call: _e.mock.On("GetPlayerToEliminate", _a0, missionID)}
}

func (_c *Querier_GetPlayerToEliminate_Call) Run(run func(_a0 context.Context, missionID int64)) *Querier_GetPlayerToEliminate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
//   - _a0 context.Context
//   - id int64
func (_e *Querier_Expecter) GetRegionsByPlayer(_a0 interface{}, id interface{}) *Querier_GetRegionsByPlayer_Call {
	return &Querier_GetRegionsByPlayer_Call{Call: _e.mock.On("GetRegionsByPlayer", _a0, id)}
}

func (_c *Querier_GetRegionsByPlayer_Call) Run(run func(_a0 context.Context, id int64)) *Querier_GetRegionsByPlayer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
//   - _a0 context.Context
//   - missionID int64
func (_e *Querier_Expecter) GetTwoContinentsMission(_a0 interface{}, missionID interface{}) *Querier_GetTwoContinentsMission_Call {
	return &Querier_GetTwoContinentsMission_Call{Call: _e.mock.On("GetTwoContinentsMission", _a0, missionID)}
}

func (_c *Querier_GetTwoContinentsMission_Call) Run(run func(_a0 context.Context, missionID int64)) *Querier_GetTwoContinentsMission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
//   - _a0 context.Context
//   - missionID int64
func (_e *Querier_Expecter) GetTwoContinentsPlusOneMission(_a0 interface{}, missionID interface{}) *Querier_GetTwoContinentsPlusOneMission_Call {
	return &Querier_GetTwoContinentsPlusOneMission_Call{Call: _e.mock.On("GetTwoContinentsPlusOneMission", _a0, missionID)}
}

func (_c *Querier_GetTwoContinentsPlusOneMission_Call) Run(run func(_a0 context.Context, missionID int64)) *Querier_GetTwoContinentsPlusOneMission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
// ReassignMissions provides a mock function with given fields: _a0, arg
func (_m *Querier) ReassignMissions(_a0 context.Context, arg sqlc.ReassignMissionsParams) error {
	ret := _m.Called(_a0, arg)
...
func (_e *Querier_Expecter) ReassignMissions(_a0 interface{}, arg interface{}) *Querier_ReassignMissions_Call {
	return &Querier_ReassignMissions_Call{Call: _e.mock.On("ReassignMissions", _a0, arg)}
}

func (_c *Querier_ReassignMissions_Call) Run(run func(_a0 context.Context, arg sqlc.ReassignMissionsParams)) *Querier_ReassignMissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *Querier) UpdateRegionOwner(_a0 context.Context, arg sqlc.UpdateRegionOwnerParams) (int64, error) {
	ret := _m.Called(_a0, arg)
