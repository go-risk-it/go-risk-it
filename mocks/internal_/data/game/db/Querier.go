...
func (_m *Querier) BeginTx(ctx context.Context, txOptions pgx.TxOptions) (pgx.Tx, error) {
...
func (_c *Querier_BeginTx_Call) Return(_a0 pgx.Tx, _a1 error) *Querier_BeginTx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Querier_BeginTx_Call) RunAndReturn(run func(context.Context, pgx.TxOptions) (pgx.Tx, error)) *Querier_BeginTx_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetPlayerAtTurnIndex provides a mock function with given fields: ctx, arg
func (_m *Querier) GetPlayerAtTurnIndex(ctx context.Context, arg sqlc.GetPlayerAtTurnIndexParams) (sqlc.GamePlayer, error) {
	ret := _m.Called(ctx, arg)
...
func (_m *Querier) WithTx(tx pgx.Tx) db.Querier {
	ret := _m.Called(tx)
	...
	var r0 db.Querier
	if rf, ok := ret.Get(0).(func(pgx.Tx) db.Querier); ok {
		r0 = rf(tx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Querier_WithTx_Call) Return(_a0 db.Querier) *Querier_WithTx_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Querier_WithTx_Call) RunAndReturn(run func(pgx.Tx) db.Querier) *Querier_WithTx_Call {
	_c.Call.Return(run)
	return _c
}
