...
func (_e *DB_Expecter) BeginTx(ctx any, txOptions any) *DB_BeginTx_Call {
...
// CopyFrom provides a mock function for the type DB.
func (_mock *DB) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_e *DB_Expecter) CopyFrom(ctx any, tableName any, columnNames any, rowSrc any) *DB_CopyFrom_Call {
...
func (_c *DB_CopyFrom_Call) Return(n int64, err error) *DB_CopyFrom_Call {
	_c.Call.Return(n, err)

	return _c
}

func (_c *DB_CopyFrom_Call) RunAndReturn(run func(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error)) *DB_CopyFrom_Call {
	_c.Call.Return(run)
...
func (_mock *DB) Exec(context1 context.Context, s string, ifaceVals ...any) (pgconn.CommandTag, error) {
	var _ca []any
...
//   - s string
//   - ifaceVals ...interface{}
func (_e *DB_Expecter) Exec(context1 any, s any, ifaceVals ...any) *DB_Exec_Call {
	return &DB_Exec_Call{Call: _e.mock.On("Exec",
		append([]any{context1, s}, ifaceVals...)...)}
}

func (_c *DB_Exec_Call) Run(run func(context1 context.Context, s string, ifaceVals ...any)) *DB_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *DB_Exec_Call) RunAndReturn(run func(context1 context.Context, s string, ifaceVals ...any) (pgconn.CommandTag, error)) *DB_Exec_Call {
	_c.Call.Return(run)
...
func (_mock *DB) Query(context1 context.Context, s string, ifaceVals ...any) (pgx.Rows, error) {
	var _ca []any
	_ca = append(_ca, context1, s)
	_ca = append(_ca, ifaceVals...)
	ret := _mock.Called(_ca...)
...
//   - s string
//   - ifaceVals ...interface{}
func (_e *DB_Expecter) Query(context1 any, s any, ifaceVals ...any) *DB_Query_Call {
	return &DB_Query_Call{Call: _e.mock.On("Query",
		append([]any{context1, s}, ifaceVals...)...)}
}

func (_c *DB_Query_Call) Run(run func(context1 context.Context, s string, ifaceVals ...any)) *DB_Query_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *DB_Query_Call) RunAndReturn(run func(context1 context.Context, s string, ifaceVals ...any) (pgx.Rows, error)) *DB_Query_Call {
	_c.Call.Return(run)
...
func (_mock *DB) QueryRow(context1 context.Context, s string, ifaceVals ...any) pgx.Row {
	var _ca []any
	_ca = append(_ca, context1, s)
	_ca = append(_ca, ifaceVals...)
	ret := _mock.Called(_ca...)
...
//   - s string
//   - ifaceVals ...interface{}
func (_e *DB_Expecter) QueryRow(context1 any, s any, ifaceVals ...any) *DB_QueryRow_Call {
	return &DB_QueryRow_Call{Call: _e.mock.On("QueryRow",
		append([]any{context1, s}, ifaceVals...)...)}
}

func (_c *DB_QueryRow_Call) Run(run func(context1 context.Context, s string, ifaceVals ...any)) *DB_QueryRow_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *DB_QueryRow_Call) RunAndReturn(run func(context1 context.Context, s string, ifaceVals ...any) pgx.Row) *DB_QueryRow_Call {
	_c.Call.Return(run)
