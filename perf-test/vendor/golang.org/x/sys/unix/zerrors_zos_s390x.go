...
var errorList = [...]struct {
	...
	{144, "EDC5144I", "Improper link."},
	{
		145,
		"EDC5145I",
		"The parameter list is too long, or the message to receive was too large for the buffer.",
	},
	...
	{171, "EDC5171I", "An error was encountered with CPL."},
	{
		172,
		"EDC5172I",
		"An error was encountered with Application Response Measurement (ARM) component.",
	},
	{
		200,
		"EDC5200I",
		"The application contains a Language Environment member language that cannot tolerate a fork().",
	},
	{
		201,
		"EDC5201I",
		"The Language Environment message file was not found in the hierarchical file system.",
	},
	...
	{249, "EDC5249I", "The function is not allowed."},
	{
		257,
		"EDC5257I",
		"Function cannot be called in the child process of a fork() from a multithreaded process until exec() is called.",
	},
	...
	{260, "EDC5260I", "A CUN_RS_TABLE_NOT_ALIGNED error was issued by Unicode Services."},
	{
		262,
		"EDC5262I",
		"An iconv() function encountered an unexpected error while using Unicode Services.",
	},
