...
func (r *Files) RangeFilesByPackage(
	name protoreflect.FullName,
	f func(protoreflect.FileDescriptor) bool,
) {
	if r == nil {
		return
	}
...
func (r *Types) RegisterExtension(xt protoreflect.ExtensionType) error {
	...
	if prev := r.extensionsByMessage[message][field]; prev != nil {
		err := errors.New(
			"extension number %d is already registered on message %v",
			field,
			message,
		)
...
//
// This returns (nil, [NotFound]) if not found.
func (r *Types) FindMessageByName(
	message protoreflect.FullName,
...
//
// This returns (nil, [NotFound]) if not found.
func (r *Types) FindExtensionByName(
...
//
// This returns (nil, [NotFound]) if not found.
func (r *Types) FindExtensionByNumber(
	message protoreflect.FullName,
	field protoreflect.FieldNumber,
) (protoreflect.ExtensionType, error) {
	if r == nil {
...
func (r *Types) RangeExtensionsByMessage(
	message protoreflect.FullName,
	f func(protoreflect.ExtensionType) bool,
) {
	if r == nil {
		return
	}
