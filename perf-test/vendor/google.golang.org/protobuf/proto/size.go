...
func (o MarshalOptions) sizeField(
...
func (o MarshalOptions) sizeList(
...
func (o MarshalOptions) sizeMap(
	...
	mapv.Range(func(key protoreflect.MapKey, value protoreflect.Value) bool {
		size += sizeTag
		size += protowire.SizeBytes(
			o.sizeField(fd.MapKey(), key.Value()) + o.sizeField(fd.MapValue(), value),
		)
		return true
	})
	return size
