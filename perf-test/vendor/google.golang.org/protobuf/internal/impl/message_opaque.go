...
func opaqueInitHook(mi *MessageInfo) bool {
	...
	for i := 0; i < fds.Len(); i++ {
		...
		case fd.ContainingOneof() != nil && !fd.ContainingOneof().IsSynthetic():
			...
			fi = fieldInfoForOneof(
				fd,
				si.oneofsByName[fd.ContainingOneof().Name()],
				mi.Exporter,
				si.oneofWrappersByNumber[fd.Number()],
			)
		case fd.IsMap():
...
func (mi *MessageInfo) fieldInfoForMapOpaque(
	si opaqueStructInfo,
...
func (mi *MessageInfo) fieldInfoForScalarListOpaque(
	si opaqueStructInfo,
	fd protoreflect.FieldDescriptor,
	fs reflect.StructField,
) fieldInfo {
...
func (mi *MessageInfo) fieldInfoForMessageListOpaque(
	si opaqueStructInfo,
	fd protoreflect.FieldDescriptor,
	fs reflect.StructField,
) fieldInfo {
...
func (mi *MessageInfo) fieldInfoForMessageListOpaqueNoPresence(
	si opaqueStructInfo,
	fd protoreflect.FieldDescriptor,
	fs reflect.StructField,
) fieldInfo {
...
func (mi *MessageInfo) fieldInfoForScalarOpaque(
	si opaqueStructInfo,
	fd protoreflect.FieldDescriptor,
	fs reflect.StructField,
) fieldInfo {
...
func (mi *MessageInfo) fieldInfoForMessageOpaque(
	si opaqueStructInfo,
	fd protoreflect.FieldDescriptor,
	fs reflect.StructField,
) fieldInfo {
