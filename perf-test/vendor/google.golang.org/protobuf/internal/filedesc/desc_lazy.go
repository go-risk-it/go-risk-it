...
func (file *File) resolveEnumDependency(
...
func (file *File) resolveMessageDependency(
	...
	for len(b) > 0 {
		...
		case protowire.BytesType:
			...
			case genid.EnumDescriptorProto_ReservedName_field_number:
				ed.L2.ReservedNames.List = append(
					ed.L2.ReservedNames.List,
					protoreflect.Name(sb.MakeString(v)),
				)
			case genid.EnumDescriptorProto_ReservedRange_field_number:
				ed.L2.ReservedRanges.List = append(
					ed.L2.ReservedRanges.List,
					unmarshalEnumReservedRange(v),
				)
...
func (vd *EnumValue) unmarshalFull(
	b []byte,
	sb *strs.Builder,
	pf *File,
	pd protoreflect.Descriptor,
	i int,
) {
	vd.L0.ParentFile = pf
	vd.L0.Parent = pd
	...
	for len(b) > 0 {
		...
		case protowire.BytesType:
			...
			case genid.DescriptorProto_ReservedName_field_number:
				md.L2.ReservedNames.List = append(
					md.L2.ReservedNames.List,
					protoreflect.Name(sb.MakeString(v)),
				)
			case genid.DescriptorProto_ReservedRange_field_number:
				md.L2.ReservedRanges.List = append(
					md.L2.ReservedRanges.List,
					unmarshalMessageReservedRange(v),
				)
			case genid.DescriptorProto_ExtensionRange_field_number:
				r, rawOptions := unmarshalMessageExtensionRange(v)
				opts := md.L0.ParentFile.builder.optionsUnmarshaler(
					&descopts.ExtensionRange,
					rawOptions,
				)
	...
	for len(b) > 0 {
		...
		case protowire.BytesType:
			...
			case genid.FieldDescriptorProto_DefaultValue_field_number:
				fd.L1.Default.val = protoreflect.ValueOfBytes(
					v,
				) // temporarily store as bytes; later resolved in resolveMessages
...
func (xd *Extension) unmarshalFull(b []byte, sb *strs.Builder) {
	...
	for len(b) > 0 {
		...
		case protowire.BytesType:
			...
			case genid.FieldDescriptorProto_DefaultValue_field_number:
				xd.L2.Default.val = protoreflect.ValueOfBytes(
					v,
				) // temporarily store as bytes; later resolved in resolveExtensions
			case genid.FieldDescriptorProto_TypeName_field_number:
				rawTypeName = v
			case genid.FieldDescriptorProto_Options_field_number:
				rawOptions = appendOptions(rawOptions, v)
...
func (db *Builder) optionsUnmarshaler(
	...
	b []byte,
) func() protoreflect.ProtoMessage {
	if b == nil {
		return nil
	}
