...
func file_grpc_binlog_v1_binarylog_proto_rawDescGZIP() []byte {
	file_grpc_binlog_v1_binarylog_proto_rawDescOnce.Do(func() {
		file_grpc_binlog_v1_binarylog_proto_rawDescData = protoimpl.X.CompressGZIP(
			unsafe.Slice(
				unsafe.StringData(file_grpc_binlog_v1_binarylog_proto_rawDesc),
				len(file_grpc_binlog_v1_binarylog_proto_rawDesc),
			),
		)
	})
