...
var (
	...
	XDSEndpointHashKeyBackwardCompat = boolFromEnv(
	...
	RingHashSetRequestHashKey = boolFromEnv(
	...
	ALTSHandshakerKeepaliveParams = boolFromEnv(
	...
	EnableDefaultPortForProxyTarget = boolFromEnv(
