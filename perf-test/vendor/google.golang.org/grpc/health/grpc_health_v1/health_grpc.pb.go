...
type HealthClient interface {
	...
	Watch(
		...
		in *HealthCheckRequest,
		opts ...grpc.CallOption,
	) (grpc.ServerStreamingClient[HealthCheckResponse], error)
}
...
func (c *healthClient) Watch(
	...
	stream, err := c.cc.NewStream(
		ctx,
		&Health_ServiceDesc.Streams[0],
		Health_Watch_FullMethodName,
		cOpts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedHealthServer) Watch(
	*HealthCheckRequest,
	grpc.ServerStreamingServer[HealthCheckResponse],
) error {
...
func _Health_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HealthServer).Watch(
		m,
		&grpc.GenericServerStream[HealthCheckRequest, HealthCheckResponse]{ServerStream: stream},
	)
}
